...
# Force clear cache so changes in Excel always show up
st.cache_data.clear()
...
try:
    ...
    st.info("Make sure data.xlsx is in the same folder as app.py")
...
with colA:
    st.metric("Total Weight KG", "80,000")   # <--- You can change this in Excel now
